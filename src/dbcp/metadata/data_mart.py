...
county_commission_election_info = Table(
    ...
    Column("next_general_election_id", Integer, nullable=True),
    Column("next_general_election_name", String, nullable=True),
    Column("next_general_election_day", DateTime, nullable=True),
    Column("next_general_total_n_seats", Integer, nullable=True),
    Column("next_general_total_n_races", Integer, nullable=True),
    Column("next_general_all_race_names", String, nullable=True),
    Column("next_general_frequency", String, nullable=True),
    Column("next_general_reference_year", Integer, nullable=True),
    Column("next_primary_election_id", Integer, nullable=True),
    Column("next_primary_election_name", String, nullable=True),
    Column("next_primary_election_day", DateTime, nullable=True),
    Column("next_primary_total_n_seats", Integer, nullable=True),
    Column("next_primary_total_n_races", Integer, nullable=True),
    Column("next_primary_all_race_names", String, nullable=True),
    Column("next_primary_frequency", String, nullable=True),
    Column("next_primary_reference_year", Integer, nullable=True),
    Column("next_run_off_election_id", Integer, nullable=True),
    Column("next_run_off_election_name", String, nullable=True),
    Column("next_run_off_election_day", DateTime, nullable=True),
    Column("next_run_off_total_n_seats", Integer, nullable=True),
    Column("next_run_off_total_n_races", Integer, nullable=True),
    Column("next_run_off_all_race_names", String, nullable=True),
    Column("next_run_off_frequency", String, nullable=True),
    Column("next_run_off_reference_year", Integer, nullable=True),
    schema=schema,
)
