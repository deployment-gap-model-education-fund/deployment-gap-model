...
eip_projects = Table(
    ...
    Column("raw_hazardous_air_pollutants_haps", String),
...
eip_facilities = Table(
    ...
    Column("raw_estimated_population_within_3_miles", String),
    Column("raw_percent_people_of_color_within_3_miles", String),
    Column("raw_percent_low_income_within_3_miles", String),
    Column("raw_percent_under_5_years_old_within_3_miles", String),
    Column("raw_percent_people_over_64_years_old_within_3_miles", String),
    Column("raw_air_toxics_cancer_risk_nata_cancer_risk", String),
    Column("raw_respiratory_hazard_index", String),
    Column("raw_pm2_5_ug_per_m3", String),
    Column("raw_o3_ppb", String),
