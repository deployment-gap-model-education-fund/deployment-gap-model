...
mcoe = Table(
    ...
    Column("associated_combined_heat_power", String),
    Column("balancing_authority_code_eia", String),
    Column("balancing_authority_name_eia", String),
    Column("bga_source", String),
    Column("bypass_heat_recovery", String),
    Column("capacity_factor", Float),
    Column("capacity_mw", Float),
    Column("carbon_capture", String),
    Column("city", String),
    Column("cofire_fuels", String),
    Column("county", String),
    Column("current_planned_operating_date", DateTime),
    Column("data_source", String),
    Column("deliver_power_transgrid", String),
    Column("distributed_generation", String),
    Column("duct_burners", String),
    ...
    Column("ferc_cogen_status", String),
    Column("ferc_exempt_wholesale_generator", String),
    Column("ferc_small_power_producer", String),
    Column("fluidized_bed_tech", String),
    Column("fuel_cost_from_eiaapi", Float),
    ...
    Column("other_planned_modifications", String),
    ...
    Column("solid_fuel_gasification", String),
    ...
    Column("state", String),
    Column("stoker_tech", String),
    Column("street_address", String),
    Column("subcritical_tech", String),
    Column("summer_capacity_estimate", String),
    ...
    Column("ultrasupercritical_tech", String),
    Column("uprate_derate_completed_date", DateTime),
    Column("uprate_derate_during_year", String),
    Column("winter_capacity_estimate", String),
